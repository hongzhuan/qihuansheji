  ...
  implements ViewPager.Decor
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    int m = View.MeasureSpec.makeMeasureSpec((int)(paramInt1 * 0.8F), -2147483648);
    int n = View.MeasureSpec.makeMeasureSpec(paramInt2 - k, -2147483648);
  ...
  void updateText(int paramInt, PagerAdapter paramPagerAdapter)
  {
    ...
    for (Object localObject = paramPagerAdapter.getPageTitle(paramInt);; localObject = null)
    {
      ...
      m = View.MeasureSpec.makeMeasureSpec((int)((m - n - i1) * 0.8F), -2147483648);
      i = View.MeasureSpec.makeMeasureSpec(i - j - k, -2147483648);
